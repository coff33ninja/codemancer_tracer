...
**Imports:** importlib, json, modules.device_detector, TTS.config.shared_configs, modules.model_training, modules.dataset, torch, sounddevice, os, dotenv, modules.utils, modules.download_and_models, modules.install_dependencies, subprocess, modules.api_key_setup, TTS.api, TTS.tts.configs.xtts_config, TTS.tts.models.xtts, modules.db_setup, modules.config, sys

## voice_assistant

**Functions:** task_name(task), on_wakeword_detected(), run_assistant()

**Imports:** asyncio, typing, wakeword_detector, warnings, modules.intent_classifier, modules.tts_service, logging, modules.llm_service, modules.file_watcher_service, nest_asyncio, modules.contractions, modules.weather_service, modules.audio_utils, modules.intent_logic, modules.db_manager, modules.stt_service, threading, platform

## wakeword_detector

**Functions:** get_porcupine_key(), test_callback()

**Imports:** os, asyncio, precise_runner, logging, modules.config, sounddevice, pvporcupine
...
**Imports:** os, json, re, logging, spellchecker
...
**Imports:** asyncio, datetime, sqlite3, config
...
**Imports:** pathlib, logging, torch, sys, subprocess, GPUtil, platform
...
**Imports:** modules.stt_model_selection, os, modules.whisperx_setup, TTS.tts.configs.xtts_config, TTS.tts.models.xtts, dotenv, sounddevice, TTS.config.shared_configs, torch, sys, subprocess, TTS.api, modules.whisper_setup, config, urllib.request

## error_handling

**Functions:** async_error_handler(timeout), decorator(func)

**Imports:** asyncio, logging, typing, functools
...
**Imports:** os, watchdog.events, typing, time, logging, watchdog.observers
...
**Imports:** os, dotenv, logging, modules.config, sys, subprocess, TTS.api, platform, shutil

## intent_classifier

**Functions:** initialize_intent_classifier()

**Imports:** os, asyncio, typing, torch, joint_model, transformers, config, pandas

## intent_logic

**Functions:** intent_handler(intent_name), decorator(func), get_response(intent_key)

**Imports:** modules.reminder_utils, asyncio, modules.calendar_utils, modules.gui_utils, json, re, logging, modules.db_manager, os, typing, datetime, modules.llm_service, modules.contractions, modules.weather_service, scripts.intent_validator, dateparser, modules.intent_classifier, modules.retrain_utils, modules.error_handling, threading, pandas, modules.tts_service, modules.config, modules.stt_service, modules.audio_utils
...
**Imports:** transformers.utils, typing, dataclasses, torch, transformers

## llm_service

**Functions:** get_session_history(session_id), initialize_llm(), get_llm_response_sync(input_text)

**Imports:** langchain_core.runnables.config, asyncio, typing, langchain_community.llms, config, langchain_core.runnables.history, langchain_core.prompts, langchain_core.chat_history, langchain_community.chat_message_histories

## model_training

**Functions:** fine_tune_model(dataset_path, model_save_path), process_data_for_joint_model(examples)

**Imports:** os, argparse, typing, json, re, torch, modules.contractions, sys, transformers, modules.joint_model, subprocess, scripts.intent_validator, datasets, pandas
...
**Imports:** re, logging, typing, datetime

## retrain_utils

**Functions:** parse_retrain_request(text)

**Imports:** os, asyncio, subprocess, sys
...
**Imports:** whisperx, asyncio, numpy, config

## tts_service

**Functions:** initialize_tts(), text_to_speech(text)

**Imports:** os, asyncio, TTS.tts.configs.xtts_config, TTS.tts.models.xtts, TTS.config.shared_configs, torch, TTS.api, config, sounddevice
...
**Imports:** os, asyncio, typing, logging, config, aiohttp

## whisperx_setup

**Functions:** get_project_root(), setup_whisperx()

**Imports:** os, dotenv, modules.config, sys, tempfile, whisperx, subprocess, scipy.io.wavfile, sounddevice
...
**Imports:** os, numpy, dotenv, modules.config, tempfile, scipy.io.wavfile, sounddevice, whisper
...
**Imports:** os, typing, datetime, psutil, time, logging, core.tts, platform

## weather

**Functions:** get_weather_wmo_description(code), get_weather(city_name), register_intents()

**Imports:** os, json, logging, core.tts, requests
...
**Imports:** os, typing, json, modules.device_manager, re, logging, core.tts, socket
...
**Imports:** os, json, modules.device_detector, tqdm, nltk.corpus, torch, sys, modules.contractions, transformers, subprocess, nltk, spellchecker, pandas, collections

## intent_validator

**Functions:** validate_intents()

**Imports:** os, typing, sys, modules.retrain_utils, pandas

## validate_and_clean_sentences

**Functions:** clean_sentence(text), main()

**Imports:** os, argparse, tqdm, language_tool_python, pandas
...
**Imports:** os, pytest, unittest.mock, modules.intent_classifier, torch, sys, modules.joint_model, pandas
...
**Imports:** os, pytest, numpy, unittest.mock, datetime, sys, modules.intent_logic
...
**Imports:** gc, os, pytest, transformers.utils, unittest.mock, time, torch, sys, transformers.modeling_outputs, transformers, modules.joint_model
...
**Imports:** os, pytest, unittest.mock, modules.model_training, sys, tempfile, datasets, pandas, inspect, shutil
...
**Imports:** modules.reminder_utils, os, pytest, gc, unittest.mock, datetime, time, sys, threading, inspect
...
**Imports:** os, pytest, unittest.mock, json, sys, modules.weather_service, aiohttp
